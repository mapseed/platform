...
// NOTE: monkey patch, for Leaflet versions < 1.0.0
if (!L.DomUtil.remove) {
...
L.Control.SideBySide = L.Control.extend({
  ...
  _updateClip: function () {
    ...
    this._leftLayers.forEach(function(layer, i) {
  ...
  _addEvents: function () {
    ...
    // NOTE: we're commenting out this event, as it is not useful given the way
    // we add and remove layers from the map.
