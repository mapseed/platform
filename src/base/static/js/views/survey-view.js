...
module.exports = Backbone.View.extend({
  ...
  render: function() {
    ...
    this.collection.each(function(model, i) {
      var items = TemplateHelpers.getItemsFromModel(
        self.options.surveyConfig.items,
        model,
        ["submitter_name"],
      );
      ...
      responses.push(
        _.extend(model.toJSON(), {
          submitter_name:
            model.get("submitter_name") ||
              self.options.surveyConfig.anonymous_name,
          cid: model.cid,
          pretty_created_datetime: Util.getPrettyDateTime(
            model.get("created_datetime"),
